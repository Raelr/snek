#ifndef SNEK_FRAMEBUFFER_H
#define SNEK_FRAMEBUFFER_H
...
{
    /**
     * @brief A class representing a Framebuffer in Vulkan. This class will store the Vulkan framebuffer and handle
     * it's creation using a Config sub-object. This class is unique in that it creates a framebuffer per image
     * supported by the GPU. This value is represented by the IMAGE_COUNT static variable.
     */
    class Framebuffer {
    public:

        /**
         * @brief The Config class acts as a container of useful information that framebuffers require to be built.
         * This class follows the Builder pattern and is intended to utilise function chaining for readability.
         */
        class Config
        {
        public:
            ...
            /**
             * @brief Adds a renderpass to the configuration. This renderpass will be used to create the framebuffer.
            ...
            /**
             * @brief Specifies the framebuffer rendering size. This usually corresponds to the swapchain image size.
             ...
             */
            const FrameImages* GetColorAttachments() const { return colorAttachments; }

            /**
             * @brief Returns the depth attachments used by this framebuffer.
             * @return the Config's depth attachments.
             */
            const FrameImages* GetDepthAttachments() const { return depthAttachments; }

            /**
             * @brief Returns the number of attachments provided to the Config.
             * @return the number of attachments.
             */
            const u32& GetAttachmentCount() const { return attachmentCount; }
             ...
             */
            const u32& GetLayers() const { return layers; }
        private:
        ...
        /**
         * @brief Sets the value of IMAGE_COUNT. This enforces that the number of allocated framebuffers never exceeds
         * the provided number of images.
         * @param imageCount the number of images available to the swapchain.
         */
        static void SetImageCount(const u32& imageCount) { IMAGE_COUNT = imageCount; }
        ...
        /**
         * @brief A constructor for Framebuffer which allows the Framebuffer to be initialised using a Config object.
         * @param config
         * @param device
         */
         ...
         */
        VkFramebuffer GetFramebuffer(const u32& index) { return framebuffers[index]; }
